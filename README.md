...
* [`support/4.3.0`](https://github.com/gurumukhi/youtube-screenshot/tree/support/4.3.0) is the current stable release line. All production releases and critical bug fixes are made here.
* [`master`](https://github.com/gurumukhi/youtube-screenshot/tree/master) is right now the	next-version development branch. It contains work targeting the upcoming major release.
